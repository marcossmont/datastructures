...
namespace Tests
{
    ...
    public class DoublyLinkedListTests
    {
        ...
        public void DoublyLinkedList_Add()
        {
            ...
            Assert.AreEqual(items.Tail.Data, 3);
            Assert.AreEqual(items.Tail.Previews.Data, 2);
            Assert.AreEqual(items.Tail.Previews.Previews.Data, 1);
            Assert.AreEqual(items.Count, 3);
        }

        [TestMethod]
        public void DoublyLinkedList_AddFirst()
        {
            MyLinkedList<int> items = new MyLinkedList<int>();
            items.AddFirst(1);
            items.AddFirst(2);
            ...
            Assert.AreEqual(items.Tail.Data, 1);
            Assert.AreEqual(items.Tail.Previews.Data, 2);
            Assert.AreEqual(items.Tail.Previews.Previews.Data, 3);
            Assert.AreEqual(items.Count, 3);
        }
